...
**SocialCaution - Privacy Risks** is the public, transparent codebase: full source published so anyone can review how we handle privacy and data. No secrets or internal tooling—just the app and documentation for running, contributing, and sharing.

This is a **standalone repo** with no connection to any other repository.

- **Repo name:** `socialcaution-privacy-risks`
- To publish to GitHub: create a new empty repo named `socialcaution-privacy-risks`, then run:  
  `git remote add origin https://github.com/YOUR_ORG/socialcaution-privacy-risks.git`
- To rename your local folder to match: close this project in Cursor, then rename the folder to `socialcaution-privacy-risks`.
...
git clone https://github.com/YOUR_ORG/socialcaution-privacy-risks.git
cd socialcaution-privacy-risks
...
1. Add Stripe keys to environment variables (see `.env.example`)
2. Configure webhook endpoint in Stripe Dashboard
3. Add product/price IDs to configuration (see `src/config/products.js` and Stripe Dashboard)
...
See [`docs/`](docs/) for deployment and production notes.
...
This project is licensed under the MIT License. See the [LICENSE](LICENSE) file for details, if present in this repository.

## 🆘 Support

- **Repository**: Add your GitHub repo URL after publishing (e.g. `https://github.com/YOUR_ORG/socialcaution-privacy-risks`)
- **Bug Reports**: Use the Issues tab of your repository
- **Feature Requests**: Use the Discussions tab of your repository
